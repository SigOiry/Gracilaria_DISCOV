...
only 5771 Rhodophyta pixel (3\% of the training dataset). To fill this,
gap the original training dataset of DISCOV v1.0 was updated using new
training pixel coming from the 5 drone flights
...
classes of the intertidal vegetation, the phylum of Rhodophyta (red
...
Bacillariophyceae (diatoms biofilm, in orange) and Chlorophyta (Green
...
intertidal attached to rocks. In the Saja esturay, Rhodophyta cover was
more scarsed, due to a strong chlorophyta presence on this site (Annexe
D: Section~\ref{sec-AnnexeD}).
...
identifies \emph{G. vermiculophylla} at the phylum level (Rhodophyta)
...
taxonomic resolution (Douay et al., 2022; Olmedo-Masat et al., 2020).
...
updated to include an extensive dataset of Rhodophyta pixels, we
