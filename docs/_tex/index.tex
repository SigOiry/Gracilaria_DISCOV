...
\includegraphics[width=0.95\textwidth,height=\textheight]{Figures/Low_res/Figure1/Map_site.png}
...
\includegraphics[width=0.95\textwidth,height=\textheight]{./Figures/Low_res/FigurePictures_censored.png}
...
\includegraphics[width=0.95\textwidth,height=\textheight]{./Figures/Low_res/Flowchart gracillaria.png}
...
\includegraphics[width=0.95\textwidth,height=\textheight]{./Figures/Low_res/Historical_maps.png}
...
\includegraphics[width=0.95\textwidth,height=\textheight]{./Figures/Low_res/Cover_Gracillaria_vs_Time.png}
...
\includegraphics[width=0.95\textwidth,height=\textheight]{./Figures/Low_res/plot_spectral_signature.png}
...
\includegraphics[width=3.75in,height=\textheight]{./Figures/Low_res/Belon_maps.png}
...
\includegraphics[width=0.95\textwidth,height=\textheight]{./Figures/Low_res/GAM_slope_cover.png}

}

\caption{\label{fig-Gam_Slope}DISCOV Prediction (A), RGB composition (B)
and Bathymetry (C) of the Bélon estuary site in Brittany, France. The
...
\includegraphics[width=0.95\textwidth,height=\textheight]{./Figures/Low_res/Saja_maps.png}
