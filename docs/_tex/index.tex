...
The historical aerial imagery analysis provided crucial insights into
...
development of Pacific oyster aquaculture, suggesting a potential with
the proliferation of this invasive species. These findings underscore
the crucial role of remote sensing in ecological research, particularly
in studying invasive species (Roca et al., 2022). Integrating
hyperspectral sensors could enhance species-level discrimination, while
adopting low-cost RGB-based methods could extend monitoring capacities
to a broader range of stakeholders. The larger mats could be detected at
a coarser spatial resolution, and a perspective of this work is to use
Sentinel 2 satellite images at a 10 m resolution (Davies et al., 2024b).
