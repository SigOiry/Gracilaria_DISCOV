...
ext_plot <- st_bbox(create_square_sf(4000, c(-4.025987, 43.420065)))
...
plot_Saja <- ggplot() +
  ...
  coord_sf(
    xlim = c(ext_plot[1], ext_plot[3]),
    ylim = c(ext_plot[2], ext_plot[4]),
    expand = F
  ) +
  ...
  theme(
    ...
    axis.text.x = element_text(vjust = 8.5,
                               hjust = -0.2,
                               size = 10),
...
ext_plot <- st_bbox(create_square_sf(10000, c(-3.706226, 47.805149)))
