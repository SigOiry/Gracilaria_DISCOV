...
#| echo: false
#| warning: false
#| fig-cap: DISCOV Prediction (A), RGB composition (B) and Bathymetry (C) of the Bélon estuary site in Brittany, France. The total extent of this flight was 21 hectars with a resolution of 8 mm per pixel. Bathymetry is represented as the height above mean sea level. 
#| label: fig-Gam_Slope
#| fig-width: 10
#| fig-height: 10
#| out-width: "95%"
