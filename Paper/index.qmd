...
In this study, we aim to harness the potential of drone-based multispectral remote sensing to map *Gracilaria vermiculophylla* in intertidal zones. A Neural Network classification model (DISCOV;@oiry_2024_14218984), developed by @rs16234383 to map intertidal vegetation in Europe has been update to improve red algae detection capability of the DISCOV model.  Bla bla what are we going to do ? bla bla .
...
A neural network classification model (DISCOV; @rs16234383; @oiry_2024_14218984), previously applied with success to Micasense reflectance data for mapping intertidal vegetation along the Portuguese and French Atlantic coasts, has been used in this study. The training dataset of DISCOV v1.0 [@oiry_2024_14218984] has been updated to file one of the weakness of this model. As shown by @rs16234383 the DISCOV v1.0 model was trained using only 5771 Rhodophyceae pixel (3% of the training dataset). To fill this gap the original training dataset of DISCOV v1.0 was updated using new training pixel coming from flight performed in the current study (@sec-DroneFlights)
